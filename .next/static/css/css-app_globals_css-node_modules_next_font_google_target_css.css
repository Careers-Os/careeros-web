...
.from-\[\#070B14\] {
  --tw-gradient-from: #070B14 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(7 11 20 / 0) var(--tw-gradient-to-position);
...
.via-\[\#070B14\]\/85 {
  --tw-gradient-to: rgb(7 11 20 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), rgb(7 11 20 / 0.85) var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-\[\#67E8F9\] {
...
.to-\[\#070B14\]\/30 {
  --tw-gradient-to: rgb(7 11 20 / 0.3) var(--tw-gradient-to-position);
}
.to-\[\#070B14\]\/40 {
  --tw-gradient-to: rgb(7 11 20 / 0.4) var(--tw-gradient-to-position);
}
.to-transparent {
...
.shadow-\[0_0_60px_-15px_rgba\(34\2c 211\2c 238\2c 0\.25\)\] {
  --tw-shadow: 0 0 60px -15px rgba(34,211,238,0.25);
...
.hover\:bg-\[\#67E8F9\]:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(103 232 249 / var(--tw-bg-opacity, 1));
}

.hover\:bg-\[\#5457E5\]:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(84 87 229 / var(--tw-bg-opacity, 1));
}

.hover\:text-\[\#67E8F9\]:hover {
  --tw-text-opacity: 1;
...
.focus\:ring-\[\#22D3EE\]\/30:focus {
  --tw-ring-color: rgb(34 211 238 / 0.3);
}

.focus\:ring-\[\#22D3EE\]\/50:focus {
...
.focus\:ring-offset-\[\#070B14\]:focus {
